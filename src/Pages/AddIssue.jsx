...
const AddIssue = () => {
  ...
  return (
    <div
      className="max-w-md mx-auto mt-12 rounded-xl overflow-hidden border border-[#FFD700]/70
                 shadow-xl bg-gradient-to-br from-[#2E8B57]/90 via-[#3CB371]/80 to-[#90EE90]/70 p-6"
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            name="title"
            required
            className="w-full rounded-xl border-2 border-[#FFD700] bg-white/10 px-4 py-2 text-white
                       placeholder-white/70 focus:border-[#FFD700] focus:ring-1 focus:ring-[#FFD700] outline-none transition-all duration-200"
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows="4"
            className="w-full rounded-2xl border-2 border-[#FFD700] bg-white/10 px-4 py-3 text-white
                       placeholder-white/70 focus:border-[#FFD700] focus:ring-1 focus:ring-[#FFD700] outline-none resize-none transition-all duration-200"
